const messages = {
    ...
    'Для доступа к функциям удаления и ограничения прав сделайте форвард нужных сообщений боту в приват (работает только у тех, кто добавлен в список модераторов /mod).',
