const messages = {
    ...
    '*Цитата (5)* — в группу будет отправлен случайный отрывок из книги «Колесо времени» Кастанеды;\n' +
    '*Шутка (10)* — в группу будет отправлен анекдот или забавный рассказ;\n' +
    '*Скрепка (20)* — даёт право прикрепить любое сообщение на один день (набери в ответ на него команду `/pin`);\n' +
    ...
    quotePrice: 5, jokePrice: 10, pinPrice: 20,
