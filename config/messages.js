const messages = {
  ...
  welcomeNew : [
    ...
    {text: 'Привет, $name. Ты уже прочёл книги Кастанеды или только собираешься?{| В любом случае, советую заглянуть в нашу <a href="https://nagualchat.github.io/">библиотеку</a>.}', weight: 10},
    {text: '{Привет|Приветствую|Здравствуй|Добро пожаловать|Рад тебя видеть}, $name. Сталкеры считают, что все люди делятся на <a href="https://nagualchat.github.io/Карлос%20Кастанеда%20-%20Сила%20безмолвия.html#L1702">три категории</a>). А к какой относишься ты?', weight: 10}
  ],
  ...
  welcomeRet2 : [
    {text: 'С возвращением, $name. Давно тебя не было видно.{| Я скучал.}', weight: 20},
    {text: 'Где тебя носило, $name? Ты многое пропустил.', weight: 10}
  ],
  ...
  '<b>Цитата (2)</b> — в группу будет отправлен случайный отрывок из книги «Колесо времени» Кастанеды.\n' +
  '<b>Шутка (5)</b> — в группу будет отправлен анекдот или забавный рассказ.\n' +
  '<b>Скрепка (10)</b> — даёт право прикрепить любое сообщение на один день (набери в ответ на него команду <code>/pin</code>).\n' +
  '<b>Подарок (1+)</b> — возможность перевести произвольное число плюсов другому человеку (набери команду <code>/gift количество</code> в ответ на любое его сообщение).',
  ...
  deleteSpamKick : 'Сообщение участника $username было распознано как спам и автоматически удалено (а сам он выгнан).',
  deleteSpamBan : 'Сообщение участника $username было опять распознано как спам и автоматически удалено (а сам он забанен).',
  ...
  help :
  '<b>Поиск</b>\n' +
  'Поиск по книгам Кастанеды, Тайши и Флоринды работает в инлайн-режиме. Чтобы им воспользоваться, наберите в поле ввода сообщения <code>@toltebot искомая фраза</code>. Также можно ввести <code>"точный запрос"</code>, оформив его в кавычки или <code>&#8209;исключить</code> слово из поиска, поставив перед ним минус. Нажатие по одному из найденных результатов отправляет цитату в тот чат, который сейчас открыт.\n\n' +
  '<b>Плюсы</b>\n' +
  ...
  'Добавить сообщение в избранное можно написав в ответ на него команду <code>/fav название закладки</code>. Посмотреть список избранного: /favs. \n\n' +
  '<b>Модерирование</b>\n' +
