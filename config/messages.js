const messages = {
  ...
  help :
  '<b>Поиск</b>\n' +
  'Поиск по книгам Кастанеды, Тайши и Флоринды работает в <a href="https://core.telegram.org/bots/inline">инлайн-режиме</a>. Чтобы им воспользоваться, наберите в поле ввода сообщения <code>@toltebot искомая фраза</code>. Также можно ввести <code>"точный запрос"</code>, оформив его в кавычки или <code>&#8209;исключить</code> слово из поиска, поставив перед ним минус. Нажатие по одному из найденных результатов отправляет цитату в тот чат, который сейчас открыт.\n\n' +
  '<b>Плюсы</b>\n' +
