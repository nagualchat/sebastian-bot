const messages = {
    ...
    help : 'Меня зовут Себастьян, я многофункциональный роботизированный дворецкий группы @nagualchat. ' + 
    ...
    'О найденных багах пишите @eirim. Исходный код: [github](https://github.com/nagualchat/sebastian-bot).',
