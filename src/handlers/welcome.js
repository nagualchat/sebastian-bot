...
const welcomeNew = [
  ...
  { text: '{Приветствую|Здравствуй|Добро пожаловать}, $name. Если тебе понадобится что-нибудь найти в книгах Кастанеды, то набери в поле ввода <code>@toltebot искомые слова</code> и я покажу в каких текстах они встречаются. Или можешь воспользоваться поиском на <a href="http://nagualism.space">сайте</a>.', weight: 10 },
  { text: '{Приветствую|Здравствуй|Добро пожаловать}, $name. Возможно, тебе будет интересно узнать, что кроме основного чата у нас имеются дополнительные группы: <a href="https://t.me/nagualchat_exp">практика</a> и <a href="https://t.me/nagualchat_dev">разработка</a>.', weight: 10 }
];
